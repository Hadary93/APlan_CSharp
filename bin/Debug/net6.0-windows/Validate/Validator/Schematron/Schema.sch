...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:ns uri="http://dataprep.eulynx.eu/schema/Generic/1.0" prefix="generic"/>
    <sch:ns uri="http://dataprep.eulynx.eu/schema/DB/1.0" prefix="db"/>
    <sch:ns uri="http://dataprep.eulynx.eu/schema/Signalling/1.0" prefix="sig"/>
    <sch:ns uri="http://www.railsystemmodel.org/schemas/Common/1.2" prefix="rsmCommon"/>
    <sch:ns uri="http://www.railsystemmodel.org/schemas/NetEntity/1.2" prefix="rsmNE"/>
    <sch:ns uri="http://www.railsystemmodel.org/schemas/RSM1.2beta/Signalling/1.0" prefix="rsmSig"/>
    ...
    <sch:let name="mainSignalFrame-ids" value="//generic:ownsSignalFrame[(rsmCommon:id = $mainSignalAsset/sig:hasSignalFrame/@ref) and sig:isOfSignalFrameType = 'main']/rsmCommon:id"/>
    ...
    <sch:pattern>
        <sch:rule context="$mainSignalFrame">
            ...
            <sch:let name="horizontalOffsetOfReferencePoint"
                value="./sig:hasPosition[@xsi:type='HorizontalOffsetOfReferencePoint']"/>
